...
config['id']['modeltitle'] = 'Obesity by Waist Circumference Only'       
...
config['input'] = {}
config['input']['name'] = ["Sex", "Age",  "Systolic BP", "Diastolic BP", "Waist Circumference", "HDL-C", "Triglycerides",  "Fasting Glucose", "Parental History of DM", "Antihypertensive Medication Use"]     
config['input']['description'] = [] 
config['input']['CUI'] = ['C28421','C0804405','C0488055','C0488052','C2734066','C0364221', 'C0364714', 'C0363687', 'C1313937','C0684167']
config['input']['units'] = ['m=T','years','mmHg','mmHg','cm','mg/dL','mg/dL','mg/dL','','']
