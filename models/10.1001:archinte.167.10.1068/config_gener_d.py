...
config['predictors'] = {}
config['predictors']['function_inputs'] = ["Sex", "Age",  "Systolic BP", "Diastolic BP","BMI", "Waist Circumference", "HDL-C", "Triglycerides",  "Fasting Glucose", "Parental History of DM", "Antihypertensive Medication Use"] #named parameters in the submitted function
config['predictors']['cuis'] = ['C28421','C0804405','C0488055','C0488052','C1542867','C2734066','C0364221', 'C0364714', 'C0363687', 'C1313937','C0684167'] #mapping to NCI Metathesaurus CUI's
config['predictors']['labels'] = ['Male = True','years','mm Hg','mm Hg','kg/m^2','cm','mg/dL','mg/dL','mg/dL','y/n','y/n'] #labels that would be helpful to elicit responses from humans
