...
config['id']['modeltitle'] = 'Full CVD, cholesterol'         # name of specific model        'Demo Model'
...
config['model']['uncompiled'] = ['modela.py']  # some kind of pointer?  ['model.py']
config['model']['compiled'] = ['']    # some kind of pointer?  ['']
config['model']['dependList'] = 'requirements.txt'    # some kind of pointer?  'requirements.txt'
config['model']['example'] = ['examplea.py']     # some kind of pointer?  ['example.py']
