...
config['id']['modeltitle'] = '4Y Heart Failure Risk, Multivariate Score'   
...
config['input'] = {}
config['input']['name'] = ["sex", "age", "LVH", "vital capacity", "heart rate", "systolic bp", "Coronary Heart Disease", "valve disease", "diabetes", "cardiomegaly"]
config['input']['description'] = ['','','Left Ventricular Hypertrophy','','','','Myocardial Infarction','Significant Murmur','','Enlarged Heart on Electrocardiograph']
config['input']['CUI'] = ['C0086582','C0804405','C3484363','C0802682','C0488794', 'C0488055', 'C2926063', 'C1963123', 'C1315719','C0018800']             # CUIs for each input, IN ORDER                   ['C0804405','C28421']
config['input']['units'] = ['m=T','years','','Liters','bpm','mmHg','','','','']        
config['input']['datatype'] = ['bool','float','bool','float','float','float','bool','bool','bool','bool']
...
config['model']['uncompiled'] = ['model_a.py']  
config['model']['compiled'] = ['']    
config['model']['dependList'] = 'requirements.txt'  
config['model']['example'] = ['example_a.py']    
