...
config['id']['modeltitle'] = 'Calibrated CVD Model for Coronary Heart Failure'
...
config['output'] = {}
config['output']['name'] = '10Y Coronary Heart Failure Risk'   
config['output']['outcomeName'] = 'Coronary Heart Failure' 
config['output']['outcomeTime'] = '10'  
config['output']['CUI'] = ''    
config['output']['outcomeCUI'] = 'C0018802'
...
config['model']['uncompiled'] = ['model_d.py', 'model_a.py']  # some kind of pointer?  ['model.py']
