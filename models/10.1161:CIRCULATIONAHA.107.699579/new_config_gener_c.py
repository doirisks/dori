...
config['id']['modeltitle'] = 'Calibrated CVD Model for Stroke'
...
config['output'] = {}
config['output']['name'] = '10Y Stroke Risk'   
...
config['model']['uncompiled'] = ['model_c.py', 'model_a.py']  # some kind of pointer?  ['model.py']
