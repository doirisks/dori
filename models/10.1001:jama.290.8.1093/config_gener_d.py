...
config['id']['modeltitle'] = 'Point System (Stroke or Death)'
...
config['model']['uncompiled'] = ['model_d.R']  # some kind of pointer?  ['model.py']
config['model']['compiled'] = ['model_d.Rdata','model_df_d.Rdata', 'model_table_d.Rdata']
config['model']['dependList'] = 'requirements.txt'    # some kind of pointer?  'requirements.txt'
config['model']['example'] = ['example_d.R']     # some kind of pointer?  ['example.py']
