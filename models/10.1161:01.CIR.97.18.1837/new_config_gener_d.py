...
config['id']['modeltitle'] = 'LDL Cholesterol Point System (Figures 3 and 4)'
...
config['input'] = {}
config['input']['name'] = ["sex", "age", "ldl cholesterol", "hdl cholesterol", "systolic BP", "diastolic BP", "diabetic", "smoker"]            # human readable, e.g.                              ['age','gender']
config['input']['description'] = ["Male = True", "age", "low-density lipoprotein cholesterol", "hdl cholesterol", "systolic BP", "diastolic BP", "diabetic", "smoker"] 
config['input']['CUI'] = ['C28421','C0804405','C0364225','C0364221','C0488055','C0488052','C1315719','C3496611']
