...
config['predictors'] = {}
config['predictors']['function_inputs'] = ["sex" "age" "ldl cholesterol" "hdl cholesterol" "systolic BP" "diastolic BP" "diabetic" "smoker"] #named parameters in the submitted function
config['predictors']['cuis'] = ['C28421','C0804405','C0364225','C0364221','C0488055','C0488052','C1315719','C3496611'] #mapping to NCI Metathesaurus CUI's
