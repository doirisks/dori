...
config['target_population'] = 'C0043210 (no coronary heart disease, ages 35-74)' #NCI Metathesaurus CUI
config['outcome'] = '2Y risk of C0018802' #NCI Metathesaurus CUI
config['predictors'] = {}
config['predictors']['function_inputs'] = ["age","total cholesterol","hdl cholesterol","systolic BP", "alcohol consumption", 'triglycerides',"antihypertensive treatment", "diabetes", "Cigarette Smoking", "Menopause"] #named parameters in the submitted function
config['predictors']['cuis'] = ['C0804405','C0364708','C0364221','C0488055','C1716143','C0364714','C0684167', 'C1315719', 'C3173717', 'CL447856'] #mapping to NCI Metathesaurus CUI's
config['predictors']['labels'] = ['years','mg/dL','mg/dL','mmHg','converted to oz/wk (times 3oz/stddrink)','mg/dL','','','',''] #labels that would be helpful to elicit responses from humans
...
config['model_development_data']['sample_size'] = '5333'
...
import json
with open('config_c.json','w') as output:
