...
config['id']['modeltitle'] = '1 Year Mortality Risk - Table 4'
...
config['input']['name'] = [
    ...
    'Cardiac Biomarkers at Randomization', 
    'Enoxaparin User',
    'Unfractionated Heparin User',
    'Killip Class'
]
config['input']['description'] = ['Male Sex', 'Age', 'Heart Rate',  'Weight', 'Creatin Clearance', 'Current Smoker', 'Former Smoker', "ST Depression on Baseline ECG", 'T-wave inversion on baseline ECG', 'Baseline Rales', 'Prior Congestive Heart Failure', 'History of Diabetes', 'History of Peripheral Vascular Disease', 'No Positive Biomarkers at Randomization', 'Enoxaparin User', 'Unfractionated Heparin User', 'Killip Class']
config['input']['CUI'] = [
    'C0086582',
    'C0804405',
    'C0488794',
...
config['input']['units'] = ['', 'years', 'bpm', 'kg', 'mL/min', '', '', '', '', '', '', '', '', '', '', '']
config['input']['datatype'] = ['bool', 'float', 'float', 'float', 'float', 'bool', 'bool', 'bool', 'bool', 'bool', 'bool', 'bool', 'bool', 'bool', 'bool', 'int'] 
config['input']['upper'] = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '4']
config['input']['lower'] = ['', '30', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1']
