...
config['id']['modeltitle'] = '1 Year Mortality Risk after 30 Days - Nomogram: Figures 2 and 3'
...
config['input']['description'] = ['Male Sex', 'Age','Creatinine Clearance', 'Weight', 'Hemoglobin',    'Platelets', 'Nadir Platelets', 'Atrial Fibrillation', 'Statins at 30 Days', 'Coronary Artery Bypass Grafting within 30 days']
config['input']['CUI'] = [
    'C0086582',
    'C0804405',
    'C1507751',
...
config['input']['units'] = ['', 'years', 'mL/min', 'kg', 'g/dL', '10^3/mm^3', '10^3/mm^3', '', '', '']
config['input']['datatype'] = ['bool', 'float', 'float', 'float', 'float', 'float', 'float', 'bool', 'bool', 'bool']
config['input']['upper'] = [''] * 10
config['input']['lower'] = ['', '30'] + [''] * 8
