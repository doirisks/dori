...
config['id']['modeltitle'] = 'Cox Model for Hemorrhagic Stroke'
...
config['input'] = {}
config['input']['name'] = ['Age', 'Diastolic Blood Pressure', 'Platelets','Albumin','History of Coronary Heart Failure', 'Asian Ethnicity', 'Black Ethnicity', 'Warfarin', 'Rivaroxaban']
config['input']['description'] = ['Age', 'Diastolic Blood Pressure', 'Platelets','Albumin','History of Coronary Heart Failure', 'Asian Ethnicity', 'Black Ethnicity', 'Warfarin', 'Rivaroxaban']
config['input']['CUI'] = ['C0804405', 'C0488052', 'C1977245', 'C0363892', 'C0018802', 'C0078988', 'C0005680', 'C1532949', 'C1739768']
config['input']['units'] = ['years', 'mmHg', '10^9/L', 'g/dL',  '', '', '', '', '']
config['input']['datatype'] = ['float', 'float', 'float', 'float', 'bool', 'bool', 'bool', 'bool', 'bool'] 
config['input']['upper'] = ['', '', '', '', '', '', '', '', '']
config['input']['lower'] = ['18', '', '', '', '', '', '', '', '']

# human and machine readable output descriptions
config['output'] = {}
config['output']['name'] = str(1003.988889 / 365.25) + 'Y Risk of Hemorrhagic Stroke'
config['output']['outcomeName'] = 'Hemorrhagic Stroke'
config['output']['outcomeTime'] = str(1003.988889 / 365.25)
config['output']['CUI'] = ''
